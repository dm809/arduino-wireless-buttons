...
const SITE_REVIEWS = [
  ...
  },
  {
    name: 'María L.',
    rating: 5,
    text: 'Placa de aire acondicionado Mitsubishi — otros decían que no tiene arreglo. Dmitrii la reparó y probó. Impresionante.',
    date: '2026-02-14T13:45:00.000Z',
  },
  {
    name: 'David P.',
    rating: 5,
    text: 'Подключение наружных блоков — силовая линия, связь, заземление. Всё по схеме, проверил под нагрузкой. Надёжно.',
